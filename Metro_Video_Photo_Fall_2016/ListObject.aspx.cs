...
{
    public partial class ListObject : System.Web.UI.Page
    {
            ...
            if (!Page.IsPostBack)
            {
                try
                {
                    ...
                    if (ds.Rows.Count > 0)
                    {
                        ...
                        dropDownTableName.Items.Insert(0, new ListItem("--Select--", "--Select--"));
                    }
                }
                catch (Exception ex) { }
                ...
                try
                {
                    ...
                    if (ds.Rows.Count > 0) 
                    {
                        ...
                        dropDownDocType.Items.Insert(0, new ListItem("--Select--", "--Select--"));
                    }
