...
{
    public class DataBaseUtilityMaster : BaseMasterPage
    {
        static Char[] delim = { ',' };
        Char[] delim2 = { '\r', '\n' };
        ...
        //public static String _connectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source =|DataDirectory|\Frontend.accdb";
        ...
        //    String _connectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source =|DataDirectory|\Frontend.accdb";
