<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewJobs.aspx.cs" Inherits="Metro_Video_Photo_Fall_2016.Application.Human_Resource.Hiring.Jobs.ViewJobs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div style="height: auto">
            <uc1:DisplayTable runat="server" ID="DisplayTable" query="select * from jobdescription" tableName ="jobdescription" />
        </div>
        <div class="row">
